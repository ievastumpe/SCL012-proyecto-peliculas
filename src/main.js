...
function hideStartMovie() {
  ...
  for (let i = 0; i < sectionMovies.length; i++) {
    ...
    fetch(`http://www.omdbapi.com/?i=${idMovie}&apikey=90f8aca6`)
...
function hideStartSeries() {
  ...
  for (let i = 0; i < sectionSeries.length; i++) {
    ...
    fetch(`http://www.omdbapi.com/?i=${idSerie}&apikey=90f8aca6`)
      .then(function(response) {
        return response.json();
      })
      .then(function(data) {
...
function hideStartDrama() {
  ...
  for (let i = 0; i < sectionDrama.length; i++) {
    ...
    fetch(`http://www.omdbapi.com/?i=${idDrama}&apikey=90f8aca6`)
      .then(function(response) {
        return response.json();
      })
      .then(function(data) {
...
function hideStartComedy() {
  ...
  for (let i = 0; i < sectionComedy.length; i++) {
    ...
    fetch(`http://www.omdbapi.com/?i=${idComedy}&apikey=90f8aca6`)
      .then(function(response) {
        return response.json();
      })
      .then(function(data) {
...
function hideStartAction() {
  ...
  for (let i = 0; i < sectionAction.length; i++) {
    ...
    fetch(`http://www.omdbapi.com/?i=${idAction}&apikey=90f8aca6`)
      .then(function(response) {
        return response.json();
      })
      .then(function(data) {
...
function hideStartCrime() {
  ...
  for (let i = 0; i < sectionCrime.length; i++) {
    ...
    fetch(`http://www.omdbapi.com/?i=${idCrime}&apikey=90f8aca6`)
      .then(function(response) {
        return response.json();
      })
      .then(function(data) {
...
function hideStartThriller() {
  ...
  for (let i = 0; i < sectionThriller.length; i++) {
    ...
    fetch(`http://www.omdbapi.com/?i=${idThriller}&apikey=90f8aca6`)
      .then(function(response) {
        return response.json();
      })
      .then(function(data) {
...
function hideStartRomance() {
  ...
  for (let i = 0; i < sectionRomance.length; i++) {
    ...
    fetch(`http://www.omdbapi.com/?i=${idRomance}&apikey=90f8aca6`)
      .then(function(response) {
        return response.json();
      })
      .then(function(data) {
...
function hideStartAdventure() {
  ...
  for (let i = 0; i < sectionAdventure.length; i++) {
    ...
    fetch(`http://www.omdbapi.com/?i=${idAdventure}&apikey=90f8aca6`)
      .then(function(response) {
        return response.json();
      })
      .then(function(data) {
...
function searchTitle() {
  ...
  fetch(`http://www.omdbapi.com/?s=${searchInput.value}&apikey=90f8aca6`)
    .then(function(response) {
      return response.json();
    })
    .then(function(json) {
      ...
      for (let i = 0; i < movieId.length; i++) {
        ...
        fetch(`http://www.omdbapi.com/?i=${idSearch}&apikey=90f8aca6`)
          .then(function(response) {
            return response.json();
          })
          .then(function(data) {
